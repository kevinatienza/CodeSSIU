...
urlpatterns = patterns('imageupload.core.views',
	...
	url(r'^twitter_base$', 'main', name='twitter_oauth_main'),
    url(r'^auth/$', 'auth', name='twitter_oauth_auth'),
    url(r'^return/$', 'return_', name='twitter_oauth_return'),
    url(r'^twitter_list/$', 'friend_list', name='twitter_oauth_friend_list'),
    url(r'^clear/$', 'unauth', name='twitter_oauth_unauth'),
)
