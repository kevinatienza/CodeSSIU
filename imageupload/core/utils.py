...
CONSUMER_KEY = getattr(settings, 'CONSUMER_KEY', 'yHM34L3mEVFLefe4G66Ng')
CONSUMER_SECRET = getattr(settings, 'CONSUMER_SECRET', 'm9QML6kdrtAelqZbrnFUNuR7mFATkDcsUh2mTVWe4Y')
